...
const CACHE_NAME = 'levelup-v1.0.3';
const STATIC_CACHE_NAME = 'levelup-static-v1.0.3';
const DYNAMIC_CACHE_NAME = 'levelup-dynamic-v1.0.3';

// 운영 환경 최적화 - 조용한 Service Worker
